...
public class ChessModel {
                ...
                if(piece == null) {
                    ...
                    switch (piece.getRank()) {
                        case KING:
                            ...
                            break;
                        case QUEEN:
                            desc += piece.getPlayer() == Player.WHITE ? " q" : " Q";
                            break;
                        case BISHOP:
                            desc += piece.getPlayer() == Player.WHITE ? " b" : " B";
                            break;
                        case ROOK:
                            desc += piece.getPlayer() == Player.WHITE ? " r" : " R";
                            break;
                        case KNIGHT:
                            desc += piece.getPlayer() == Player.WHITE ? " n" : " N";
                            break;
                        case PAWN:
    ...
    public static void main(String[] args) {
        ChessModel md = new ChessModel();
        md.reset();
//		md.movePiece(0, 1, 0, 2);
//		md.movePiece(1, 1, 1, 2);
