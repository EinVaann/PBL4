...
public class Options_GUI extends JFrame {
	...
	public Options_GUI() {
		...
		btnApply.setBounds(10, 337, 111, 40);
		...
		btnReset.setBounds(183, 337, 195, 40);
		...
		btnBackToMenu.setFont(new Font("Tahoma", Font.PLAIN, 20));
		btnBackToMenu.setBounds(97, 399, 170, 40);
