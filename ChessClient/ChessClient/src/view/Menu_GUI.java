...
//		        Calculate c = new Calculate();
		        ...
		        board.ShowBoard();
		        ChessView single = new ChessView(board,txtName.getText(), false); 
			}
		});
	...
	//	        Calculate c = new Calculate();
		        board.CreateBoard(fenCode);
		        board.ShowBoard();
		        ChessView multi = new ChessView(board,txtName.getText(),true);
		        multi.ClientThread.sendToServer("/listChannel");
		        }
			}
		});
